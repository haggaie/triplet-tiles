 ...
 *       - zipf: exponent (+ optional order); total triplet count is always derived from layered silhouette capacity
 *       - weightedTriplets: weights { [typeId]: number }; total triplets always derived from capacity (same as zipf)
 *     - templateTripletFillRatio (optional): 0–1, default 1 — scale derived triplet count: floor(maxTiles*ratio/3)
 ...
 *   - paramRanges.templateTripletFillRatio: optional 0–1 (same as batch); triplets always derived from shape in pool mode
...
module.exports = {
  ...
  levels: [
    // Easy: regular silhouettes, shallow depth, fewer types.
    {
      ...
      distribution: { mode: 'zipf', exponent: 0.4 },
      layering: {
        minZ: 0,
    ...
    },
    {
      ...
      distribution: { mode: 'zipf', exponent: 0.9 },
    ...
    },
    {
      ...
      tileTypeCount: 12,
      solverConstraints: { requireMinSlackAtMost: 1 },
      distribution: { mode: 'zipf', exponent: 1.0 },
    ...
    // Hard: deeper stacks, 12 types, higher skew and pressure.
    {
      ...
      tileTypeCount: 12,
      solverConstraints: { requireMinSlackAtMost: 1 },
      distribution: { mode: 'zipf', exponent: 1.15 },
    ...
    },
    {
      ...
      tileTypeCount: 12,
      solverConstraints: { requireMinSlackAtMost: 1 },
      distribution: { mode: 'zipf', exponent: 1.25 },
    ...
    },
    {
      ...
      tileTypeCount: 12,
      solverConstraints: { requireMinSlackAtMost: 1, requireMaxDifficultyRange: 0.5 },
      distribution: { mode: 'zipf', exponent: 1.55 },
