...
const MESSAGES = {
  en: {
    ...
    'levelSelect.completedLabel': 'completed',
    ...
    'audio.allSoundGroup': 'All sound',
    'audio.allSoundOn': 'All sound on',
    'audio.allSoundOff': 'All sound off',
    'audio.allSoundMuteTitle': 'Mute music and sound effects',
    'audio.allSoundUnmuteTitle': 'Unmute music and sound effects',
    'audio.masterMuteSrLabel': 'Mute all sound',
    'settings.heading': 'Settings',
    'settings.close': 'Close',
    'settings.closeDetail': 'Close settings',
    'settings.sectionDisplay': 'Display',
    'settings.sectionSound': 'Sound',
    'settings.sectionVibrate': 'Vibrate',
    'settings.installHint': 'Install the game as an app for more screen space without the browser bar.',
    'settings.vibrateRowLabel':
      'Short buzzes when you match and when levels end (on supported phones).',
    'settings.resetDefaults': 'Reset to defaults',
    'settings.resetDefaultsDetail':
      'Restore default music, sound effects, and vibration (does not reset level progress)',
  ...
  es: {
    ...
    'levelSelect.completedLabel': 'completado',
    ...
    'audio.allSoundGroup': 'Todo el sonido',
    'audio.allSoundOn': 'Sonido activado',
    'audio.allSoundOff': 'Sonido desactivado',
    'audio.allSoundMuteTitle': 'Silenciar música y efectos',
    'audio.allSoundUnmuteTitle': 'Activar música y efectos',
    'audio.masterMuteSrLabel': 'Silenciar todo el sonido',
    'settings.heading': 'Ajustes',
    'settings.close': 'Cerrar',
    'settings.closeDetail': 'Cerrar ajustes',
    'settings.sectionDisplay': 'Pantalla',
    'settings.sectionSound': 'Sonido',
    'settings.sectionVibrate': 'Vibración',
    'settings.installHint': 'Instala el juego como app para ganar pantalla sin la barra del navegador.',
    'settings.vibrateRowLabel':
      'Pequeñas vibraciones al combinar y al terminar niveles (en teléfonos compatibles).',
    'settings.resetDefaults': 'Restablecer predeterminados',
    'settings.resetDefaultsDetail':
      'Restaurar música, efectos y vibración por defecto (no reinicia el progreso)',
    'settings.openAria': 'Ajustes',
    'settings.openTitle': 'Abrir ajustes',
    'credits.full':
  ...
  de: {
    ...
    'levelSelect.completedLabel': 'geschafft',
    ...
    'audio.allSoundGroup': 'Gesamter Sound',
    'audio.allSoundOn': 'Ton an',
    'audio.allSoundOff': 'Ton aus',
    'audio.allSoundMuteTitle': 'Musik und Effekte stummschalten',
    'audio.allSoundUnmuteTitle': 'Musik und Effekte einschalten',
    'audio.masterMuteSrLabel': 'Alle Geräusche stumm',
    'settings.heading': 'Einstellungen',
    'settings.close': 'Schließen',
    'settings.closeDetail': 'Einstellungen schließen',
    'settings.sectionDisplay': 'Anzeige',
    'settings.sectionSound': 'Ton',
    'settings.sectionVibrate': 'Vibration',
    'settings.installHint':
      'Installiere das Spiel als App für mehr Platz ohne Browserleiste.',
    'settings.vibrateRowLabel':
      'Kurzes Vibrieren bei Matches und am Levelende (auf unterstützten Geräten).',
    'settings.resetDefaults': 'Standard wiederherstellen',
    'settings.resetDefaultsDetail':
      'Standard für Musik, Soundeffekte und Vibration (Fortschritt bleibt erhalten)',
    'settings.openAria': 'Einstellungen',
    'settings.openTitle': 'Einstellungen öffnen',
    'credits.full':
  ...
  ru: {
    ...
    'levelSelect.completedLabel': 'пройден',
    ...
    'audio.allSoundGroup': 'Весь звук',
    'audio.allSoundOn': 'Звук включён',
    'audio.allSoundOff': 'Звук выключен',
    'audio.allSoundMuteTitle': 'Выключить музыку и эффекты',
    'audio.allSoundUnmuteTitle': 'Включить музыку и эффекты',
    'audio.masterMuteSrLabel': 'Отключить весь звук',
    'settings.heading': 'Настройки',
    'settings.close': 'Закрыть',
    'settings.closeDetail': 'Закрыть настройки',
    'settings.sectionDisplay': 'Экран',
    'settings.sectionSound': 'Звук',
    'settings.sectionVibrate': 'Вибрация',
    'settings.installHint':
      'Установите игру как приложение — больше места без панели браузера.',
    'settings.vibrateRowLabel':
      'Короткая вибрация при комбинациях и в конце уровня (на поддерживаемых телефонах).',
    'settings.resetDefaults': 'Сбросить настройки звука',
    'settings.resetDefaultsDetail':
      'Вернуть музыку, эффекты и вибрацию по умолчанию (прогресс не сбрасывается)',
    'settings.openAria': 'Настройки',
    'settings.openTitle': 'Открыть настройки',
    'credits.full':
  ...
  he: {
    ...
    'levelSelect.completedLabel': 'הושלם',
    'difficulty.easy': 'קל',
    ...
    'audio.allSoundGroup': 'כל הצליל',
    'audio.allSoundOn': 'כל הצליל פועל',
    'audio.allSoundOff': 'כל הצליל כבוי',
    'audio.allSoundMuteTitle': 'השתקת מוזיקה ואפקטים',
    'audio.allSoundUnmuteTitle': 'הפעלת מוזיקה ואפקטים',
    'audio.masterMuteSrLabel': 'השתק את כל הצליל',
    'settings.heading': 'הגדרות',
    'settings.close': 'סגור',
    'settings.closeDetail': 'סגירת הגדרות',
    'settings.sectionDisplay': 'תצוגה',
    'settings.sectionSound': 'צליל',
    'settings.sectionVibrate': 'רטט',
    'settings.installHint': 'התקינו את המשחק כאפליקציה לשטח מסך גדול יותר בלי סרגל הדפדפן.',
    'settings.vibrateRowLabel': 'רטטים קצרים בהתאמות ובסיום שלב (בטלפונים שתומכים בכך).',
    'settings.resetDefaults': 'שחזור ברירת מחדל',
    'settings.resetDefaultsDetail':
      'שחזור מוזיקה, אפקטים ורטט לברירת מחדל (בלי לאפס התקדמות)',
    'settings.openAria': 'הגדרות',
    'settings.openTitle': 'פתיחת הגדרות',
    'credits.full':
  ...
  ar: {
    ...
    'levelSelect.completedLabel': 'مكتمل',
    ...
    'audio.allSoundGroup': 'كل الصوت',
    'audio.allSoundOn': 'الصوت مفعّل',
    'audio.allSoundOff': 'الصوت معطّل',
    'audio.allSoundMuteTitle': 'كتم الموسيقى والمؤثرات',
    'audio.allSoundUnmuteTitle': 'تشغيل الموسيقى والمؤثرات',
    'audio.masterMuteSrLabel': 'كتم كل الصوت',
    'settings.heading': 'الإعدادات',
    'settings.close': 'إغلاق',
    'settings.closeDetail': 'إغلاق الإعدادات',
    'settings.sectionDisplay': 'العرض',
    'settings.sectionSound': 'الصوت',
    'settings.sectionVibrate': 'الاهتزاز',
    'settings.installHint': 'ثبّت اللعبة كتطبيق للحصول على مساحة أكبر دون شريط المتصفح.',
    'settings.vibrateRowLabel':
      'اهتزازات قصيرة عند التطابق وعند انتهاء المراحل (على الهواتف التي تدعم ذلك).',
    'settings.resetDefaults': 'استعادة الافتراضي',
    'settings.resetDefaultsDetail':
      'استعادة الموسيقى والمؤثرات والاهتزاز للوضع الافتراضي (دون مسح التقدّم)',
    'settings.openAria': 'الإعدادات',
    'settings.openTitle': 'فتح الإعدادات',
    'credits.full':
