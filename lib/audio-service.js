  ...
  function prepareSfx() {
    ...
    sfxLoadPromise = (async () => {
      try {
        ...
        /* Do not await resume here: unlock() schedules this async IIFE outside the
         * user-gesture stack; some browsers leave resume()'s promise pending forever.
         * decodeAudioData works while suspended; playSfxAsync awaits resume again before start(). */
